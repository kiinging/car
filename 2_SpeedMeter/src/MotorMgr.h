...
public:
	 ...
	 */
	MotorMgr(uint8_t gpCW, uint8_t gpCCW, uint8_t gpA, uint8_t gpB, int16_t numTicks = 211); // Default value for xNumTicks
	virtual ~MotorMgr();
    ...
    int16_t EncoderPosition();  // <-- Add this declaration here
